...
**text color** by embedding inline **HTML tags**

| Style Type           | HTML Snippet Example                                         |
| -------------------- | ------------------------------------------------------------ |
| **Color Name**       | `<span style="color:blue">Blue Text</span>` <span style="color:blue">Blue Text</span> |
| **Hex Code**         | `<span style="color:#FF5733">Orange Text</span>` <span style="color:#FF5733">Orange Text</span> |
| **RGB Value**        | `<span style="color:rgb(0, 128, 0)">Green Text</span>` <span style="color:rgb(0, 128, 0)">Green Text</span> |
| **Background Color** | `<span style="background-color:yellow">Highlighted Text</span>` <span style="background-color:yellow">Highlighted Text</span> |
| **Combined**         | `<span style="color:white; background-color:black">White text on black</span>` <span style="color:white; background-color:black">White text on black</span> |
