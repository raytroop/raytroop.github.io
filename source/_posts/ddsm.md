...
![image-20251014070517171](ddsm/image-20251014070517171.png)

![ddsm_fracpll_zoh.drawio](ddsm/ddsm_fracpll_zoh.drawio.svg)

$$\begin{align}
S_\phi(f) &= \frac{1}{12F_{ref}}|1-z^{-1}|^{2L}\cdot \left|\frac{2\pi z_{-1}}{1-z^{-1}}\right|^2\cdot \frac{1}{T_{ref}^2} T_{ref}^2 \\
&= \frac{1}{12F_{ref}} |1-z^{-1}|^{2L-2} 4\pi^2
\end{align}$$
...
![image-20250922224650348](ddsm/image-20250922224650348.png)
