...
The idea of harmonic balance is to find a set of prot voltage waveforms (or, alternatively, the harmonic voltage components) that give the same currents in both the *linear-network equations* and *nonlinear-network equations*
